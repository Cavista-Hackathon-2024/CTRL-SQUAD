...
const HomePage = () => {
  return (
    <div>
      <section className="mt-2 font-bold w-[90vw] lg:mt-8 ">
        <div className="relative bg-red-500 rounded-full h-[50px] w-[50px]  flex flex-col lg:ml-[250px] ml-[50px]  mt-[50px] cursor-pointer transition-transform hover:-translate-y-1 border-b shadow-lg pr-6">
        {/* <svg class="w-6 h-6 text-white ml-3 mt-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
  <path d="M7.978 4a2.553 2.553 0 0 0-1.926.877C4.233 6.7 3.699 8.751 4.153 10.814c.44 1.995 1.778 3.893 3.456 5.572 1.68 1.679 3.577 3.018 5.57 3.459 2.062.456 4.115-.073 5.94-1.885a2.556 2.556 0 0 0 .001-3.861l-1.21-1.21a2.689 2.689 0 0 0-3.802 0l-.617.618a.806.806 0 0 1-1.14 0l-1.854-1.855a.807.807 0 0 1 0-1.14l.618-.62a2.692 2.692 0 0 0 0-3.803l-1.21-1.211A2.555 2.555 0 0 0 7.978 4Z"/>
      ...
      <i className="fi fi-rs-ambulance w-40 h-20 text-white ml-[18px] mt-4 "></i>
        ...
        <span className="lg:flex hidden text-gray-500  float-bottom lg:ml-[250px]">Request for an ambulance immediately</span>
        <div class="max-w-sm p-6 bg-white border border-gray-200 float-right rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-[250px] mt-[-60px]">
        <h5 class="mb-4 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Join our healthcare providers</h5>
  ...
  <div class="py-8 px-4 mx-auto mt-[50px] max-w-screen-xl lg:py-16 lg:px-6 lg:mb-[-100px] lg:mt-9">
      <div class="max-w-screen-lg mt-[50px] text-gray-500 sm:text-lg dark:text-gray-400">
          <h2 class="mb-2 text-4xl tracking-tight font-bold text-gray-900 dark:text-white">Empowering Health Innovations for over <span class="font-extrabold">200,000+</span> companies worldwide</h2>
...
Enhance Healthcare Collaboration and Issue Tracking with Integrated Platforms</p>
    ...
    <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
        <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">Schedule Your Appointment: Take Charge of Your Health</h1>
